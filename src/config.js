...
export const MOON_CONFIG = {
    MIN_SIZE_RATIO: 0.1,   // Minimum moon size as a fraction of planet size
    MAX_SIZE_RATIO: 0.4,   // Maximum moon size as a fraction of planet size
    MIN_ORBIT_RATIO: 2,    // Minimum orbit distance (in planet radii)
    MAX_ORBIT_RATIO: 4     // Maximum orbit distance (in planet radii)
};
